...
class gnu_02(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "gnu_02")
        ...
        self.qtgui_time_sink_x_0_1_1_0.enable_stem_plot(True)
        ...
        self.qtgui_time_sink_x_0_1_1.enable_stem_plot(True)
        ...
        self.blocks_throttle2_0_1 = blocks.throttle( gr.sizeof_float*1, (samp_rate*0.8), True, 0 if "auto" == "auto" else max( int(float(0.1) * (samp_rate*0.8)) if "auto" == "time" else int(0.1), 1) )
        self.blocks_throttle2_0_0 = blocks.throttle( gr.sizeof_float*1, (samp_rate*2), True, 0 if "auto" == "auto" else max( int(float(0.1) * (samp_rate*2)) if "auto" == "time" else int(0.1), 1) )
        self.blocks_throttle2_0 = blocks.throttle( gr.sizeof_float*1, samp_rate, True, 0 if "auto" == "auto" else max( int(float(0.1) * samp_rate) if "auto" == "time" else int(0.1), 1) )
        self.analog_sig_source_x_0_1 = analog.sig_source_f((samp_rate*0.8), analog.GR_COS_WAVE, 5000, 5, 0, 0)
        self.analog_sig_source_x_0_0 = analog.sig_source_f((samp_rate*2), analog.GR_COS_WAVE, 5000, 5, 0, 0)
        ...
        self.connect((self.blocks_throttle2_0, 0), (self.qtgui_time_sink_x_0_1_1_0, 0))
        self.connect((self.blocks_throttle2_0_0, 0), (self.qtgui_time_sink_x_0_1_1, 0))
        self.connect((self.blocks_throttle2_0_1, 0), (self.qtgui_time_sink_x_0_1_1_1, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.analog_sig_source_x_0_1.set_sampling_freq((self.samp_rate*0.8))
        self.blocks_throttle2_0.set_sample_rate(self.samp_rate)
        self.blocks_throttle2_0_0.set_sample_rate((self.samp_rate*2))
        self.blocks_throttle2_0_1.set_sample_rate((self.samp_rate*0.8))
        self.qtgui_time_sink_x_0_1_1.set_samp_rate(self.samp_rate*2)
        self.qtgui_time_sink_x_0_1_1_0.set_samp_rate(self.samp_rate)
        self.qtgui_time_sink_x_0_1_1_1.set_samp_rate(self.samp_rate*2)




def main(top_block_cls=gnu_02, options=None):
