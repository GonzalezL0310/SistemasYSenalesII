...
import gnu_9_epy_block_0 as epy_block_0  # embedded python block
import gnu_9_epy_block_0_0 as epy_block_0_0  # embedded python block
import sip
import threading



class gnu_9(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "gnu_9")
        ...
        self.connect((self.blocks_divide_xx_0, 0), (self.qtgui_time_sink_x_0_0_0_0, 0))
        self.connect((self.blocks_sub_xx_0, 0), (self.epy_block_0, 0))
        self.connect((self.blocks_throttle2_0, 0), (self.blocks_sub_xx_0, 0))
...
def main(top_block_cls=gnu_9, options=None):
